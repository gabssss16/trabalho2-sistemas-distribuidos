...
func main() {
	...
	for {
		...
		// Cria o envelope no padrão esperado por todo o sistema
		...
		// Assina o evento utilizando a chave privada gerada na pasta correta
		...
		// Serializa o envelope já assinado para formato JSON (bytes)
